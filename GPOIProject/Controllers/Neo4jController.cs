...
namespace GPOIProject.Controllers
{
    [Route("api/[controller]")]
    public class Neo4jController : IDisposable
    {
        private readonly IDriver _driver;
        public Neo4jController() //connesione al db di neo4j
        {
        ...
        public async Task CreateNode(Node node) //funzione per creare un nodo
        {
            ...
            try
            {
                var writeResults = await session.ExecuteWriteAsync(async tx =>
                {
                    ...
                    //parametri che andranno a sostituire i $
        ...
        public async Task UpdateNode(Node node) //aggiornare un nodo 
        {
        ...
        public async Task CreateRelationship(Node node1, Node node2) //creare una relazione
        {
        ...
        public async Task DeleteNode(Node node) //cancellare un nodo
        {
